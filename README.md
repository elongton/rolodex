...
This app makes storing contacts/organizations and their programs fun by utilizing the great features of Angular5 and Material. Users will be able to quickly add a new contact, organization or program and rate them.  Later, they can search any of these objects using various filters or by creating a query.  View design here: bit.ly/2Foj1K0
